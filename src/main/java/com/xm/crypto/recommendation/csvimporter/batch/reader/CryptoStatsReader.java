...
public class CryptoStatsReader implements ItemReader<List<CryptoStatsDTO>>, StepExecutionListener {
    ...
    public List<CryptoStatsDTO> read() {
        ...
        LocalDateTime firstDateTime = monthStartDate.with(TemporalAdjusters.firstDayOfMonth())
                .withHour(0)
                .withMinute(0)
                .withSecond(0)
                .withNano(0);
        ...
        //TODO Move to new method
        LocalDateTime lastDateTime = monthStartDate.with(TemporalAdjusters.lastDayOfMonth())
                .withHour(23)
                .withMinute(59)
                .withSecond(59)
                .withNano(999999999);

            List<Object[]> result = cryptoStatsRepository.findCryptoStats(monthStartDate.toLocalDate(), firstDateTime, lastDateTime );
